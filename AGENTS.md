...
- `state_referenced_locally` and `non_reactive_update` Svelte warnings are tracked tech debt — fix them when touching affected components rather than suppressing them.
