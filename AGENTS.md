...
- Do not call API-seeded Playwright coverage “e2e”. Keep pure user-driven browser flows in a separate `tests-e2e/` suite, and classify API-seeded browser tests explicitly as browser-integration coverage so CI names and guarantees stay honest.
