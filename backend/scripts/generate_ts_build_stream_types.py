...
from modules.compute import schemas as compute_schemas  # noqa: E402
from modules.compute.schemas import (  # noqa: E402
    ActiveBuildDetail,
    ActiveBuildSummary,
    BuildEvent,
...
OUTPUT_PATH = Path(__file__).parent.parent.parent / 'frontend' / 'src' / 'lib' / 'types' / 'build-stream.generated.ts'
