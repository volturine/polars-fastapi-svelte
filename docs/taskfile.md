...
1. ✅ File handle leak on export failure (service.py:467)
2. ✅ Pagination boundary bug (InlineDataTable.svelte:94)
3. ✅ Stale query key missing currentPage (InlineDataTable.svelte:50)
