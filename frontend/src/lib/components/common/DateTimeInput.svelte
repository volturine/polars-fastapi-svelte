...
<div class="flex gap-1 overflow-hidden">
	...
	<div class="relative min-w-0 flex-1">
		...
		{#if timeValue}
			<button
				type="button"
				class="clear-btn absolute right-1 top-1/2 -translate-y-1/2 flex h-[18px] w-[18px] cursor-pointer items-center justify-center border-none bg-transparent p-0 transition-all"
				onclick={clearTime}
				title="Clear time"
