...
class TestUpdateSettings:
    ...
    def test_preserves_masked_secrets_on_partial_update(self, client: TestClient, monkeypatch) -> None:
        from backend_core.settings_store import get_resolved_openrouter_key, get_resolved_smtp, get_resolved_telegram_token
...
class TestSettingsRuntimeCaches:
    ...
    def test_resolved_settings_cache_invalidates_after_bootstrap(self, monkeypatch) -> None:
        from backend_core.settings_store import get_resolved_default_model, get_resolved_openrouter_key, seed_settings_from_env
