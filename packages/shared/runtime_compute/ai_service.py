...
def get_ai_client(
    ...
    *,
    ...
    if normalized == 'ollama':
        from runtime_compute.settings_service import get_resolved_ollama_settings
    ...
    if normalized == 'openai':
        from runtime_compute.settings_service import get_resolved_openai_settings
    ...
    if normalized == 'openrouter':
        from runtime_compute.settings_service import get_resolved_openrouter_key
    ...
    if normalized in {'huggingface', 'huggingface-api'}:
        from runtime_compute.settings_service import get_resolved_huggingface_settings
