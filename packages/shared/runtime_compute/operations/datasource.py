...
from runtime_compute.iceberg_reader import scan_iceberg_snapshot
from runtime_compute.step_converter import convert_step_format
...
def _build_tab_pipeline(
    ...
    from runtime_compute.utils import apply_steps

    steps = apply_steps(steps)
    additional = _collect_analysis_sources(steps, pipeline, cache)

    from runtime_compute.engine import PolarsComputeEngine
